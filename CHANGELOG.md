...
- Added a `Pré-suppression` view backed by `Result/_PreSuppression` to restore or permanently delete canceled/unchanged work copies, with automatic purge after 30 days.
